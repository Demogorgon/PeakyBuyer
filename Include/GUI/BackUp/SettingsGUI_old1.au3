...
Func PlayerListDialog()
	...
	Local $List = GUICtrlCreateList("", 15, 30, 120, 130, $WS_BORDER, $SS_BLACKRECT)
	GUICtrlSetData(-1, "Lista1|Lista2", "Lista1")
	GUICtrlSetBkColor(-1, "0x3d3d3d")
	GUICtrlSetColor(-1, "0xFFFFFF")

	Local $ListNameInput = GUICtrlCreateInput("Enter list name.", 15, 145, 170, 20, BitOR($ES_LEFT, $ES_AUTOHSCROLL), $SS_BLACKRECT)
	_GUICtrlSetFont(-1, 11, 400, 0, "Verdana", 2)
	GUICtrlSetColor(-1, $FontThemeColor)
	GUICtrlSetBkColor(-1, "0x3d3d3d")
	GUICtrlSetColor(-1, "0xFFFFFF")

	Local $Save = _Metro_CreateButton("Save", 140, 30, 85, 30)
	Local $Load = _Metro_CreateButton("Load", 140, 70, 85, 30)
